      ...
      <table class="w-full text-left text-xs border-collapse">
        <thead>
          <tr class="border-b border-zinc-800 bg-zinc-900/60 text-zinc-400">
            <th class="px-3 py-2.5 font-medium w-12 text-center">
              #
            </th>
            <th class="px-3 py-2.5 font-medium w-24">
              Detected
            </th>
            <th class="px-3 py-2.5 font-medium w-24">
              Season
            ...
            <th class="px-3 py-2.5 font-medium w-24 text-right">
              Size
            </th>
            <th class="px-3 py-2.5 font-medium w-12 text-center">
              Remove
          ...
          >
            ...
            <td class="px-3 py-2 font-mono text-zinc-400 text-xs whitespace-nowrap">
              <span
                ...
                class="px-1.5 py-0.5 rounded bg-zinc-800 text-indigo-300 font-medium"
              >
            ...
            <td
              class="px-3 py-2 text-zinc-300 font-mono text-xs truncate max-w-xs"
              :title="item.fileName"
            >
              {{ item.fileName }}
            </td>
